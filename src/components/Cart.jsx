...
const Cart = () => {
  ...
  const cartshown = false ;


  return (
    <>
      <div className={` h-full w-[100vw] md:w-[30vw] bg-white  z-50 opacity-[1] absolute top-0 right-0  ${cartshown? "translate-x-[1000px]" :"translate-x-0 " }`}>
      ...
      <ImCross  className='absolute right-4 top-8 text-lg text-purple-600 cursor-pointer '></ImCross>
      </div>
