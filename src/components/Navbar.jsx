    ...
    return (
        <>
            <div className="h-28  shadow-md  flex flex-col overflow-hidden-x md:flex-row w-[100%] justify-between items-center  ">
                <div className="logo md:order-1 flex  justify-between w-[100vw] order-1   items-center ">
                ...
                <div className={` z-30 shadow-md md:shadow-none py-5 order-3 flex md:order-2  md:justify-end mx-4 font-bold text-center w-[100%] md:w-[60%] md:h-20 h-52 bg-white list-none space-x-4  transition-transform duration-200 md:translate-x-0 ${show ? 'translate-x-0 md:flex-row flex-col ' : 'translate-x-[1000px]  '}   `}>              
                        <li className="my-2 font-semibold text-gray-600 text-xl text-center  " onClick={() => setShow(show(false))}  > <Link  to='/Tshirt'>T-Shirts</Link></li>
                        <li className="my-2 font-semibold text-gray-600  text-xl text-center  " onClick={() => setShow(show(false))}  > <Link  to='/Mugs'>Mugs</Link></li>
                        <li className="my-2 font-semibold text-gray-600  text-xl text-center  " onClick={() => setShow(show(false))} > <Link  to='/Caps'>Caps</Link></li>
                       <li>
                ...
                <AiOutlineShoppingCart className="w-8 h-9 mx-2 text-gray-500 pb-1 mr-4"></AiOutlineShoppingCart>
