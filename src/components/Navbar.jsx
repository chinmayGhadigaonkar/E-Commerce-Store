  ...
  return (
    <>
      <div className="h-28   shadow-md  flex flex-col overflow-hidden-x md:flex-row w-[100%] justify-between items-center  ">
        ...
        <div
          className={` z-50 opacity-[1] shadow-md md:shadow-none py-5 order-3 flex md:order-2  md:justify-end mx-4 font-bold text-center w-[100%] md:w-[60%] md:h-20 h-52 bg-white list-none space-x-4  transition-transform duration-200 md:translate-x-0 ${
            show
        ...
        <div className=" md:static  relative   inline-flex right-10  duration-200   top-5 md:order-3 w-12 justify-between items-end  order-2  ">
          <AiOutlineShoppingCart
            ...
            className="w-8 h-9   text-purple-500  cursor-pointer  "></AiOutlineShoppingCart>
          <div className=" relative inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-purple-500 border-2 border-white rounded-full -top-4 right-1 dark:border-purple-500 ">
