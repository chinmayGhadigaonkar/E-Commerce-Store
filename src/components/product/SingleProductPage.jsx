...
const SingleProductPage = () => {
    ...
    const handleOnCart = (product)=>{
        if(localStorage.getItem("userInfo")){
            ...
            toast.error("Plz Login Before Add in Cart")
        }
                                ...
                                <div className="lg:w-4/5 mx-auto flex flex-col justify-center items-center ">
                                    ...
                                    <div className="lg:w-2/2 w-full lg:pt-10 lg:py-6 mt-6 lg:mt-0">
                                        ...
                                        <div className="flex">
                                            ...
                                            <button className="flex ml-auto text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded" onClick={()=>{handleOnCart(p)}} >Add To Cart</button>
